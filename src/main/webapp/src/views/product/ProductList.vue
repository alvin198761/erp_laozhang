                            ...
                            <el-form>
                                  <el-row :gutter="10">
                                              ...
                                              <el-form-item label="主键">{{props.row.id}}</el-form-item>
                                                                                ...
                                                                                <el-col :span="6">
                                              <el-form-item label="货号">{{props.row.prod_no}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="税收类型">{{props.row.tax_type}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="产品名称">{{props.row.prod_name}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="规格型号">{{props.row.spec_no}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="产品说明">{{props.row.note}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="单位">{{props.row.unit}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                    ...
                                    <el-table-column prop="price" label="底价"></el-table-column>
                                    <el-table-column prop="sell_price_yes" label="售卖价(含税)"></el-table-column>
                                    <el-table-column prop="sell_price_no" label="售卖价(不含税)"></el-table-column>
                                    <el-table-column prop="mark_price_yes" label="市场价(不含税)"></el-table-column>
                                    <el-table-column prop="mark_price_no" label="市场价(含税)"></el-table-column>
                                    <el-table-column prop="price_mode" label="价格类型"></el-table-column>
                                    <el-table-column prop="vendor_id" label="货物来源"></el-table-column>
                                    <el-table-column prop="pic1" label="产品图片1"></el-table-column>
                                    <el-table-column prop="pic2" label="产品图片2"></el-table-column>
                                    <el-table-column prop="pic3" label="产品图片3"></el-table-column>
