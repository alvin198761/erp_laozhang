                            ...
                            <el-form>
                                  <el-row :gutter="10">
                                              ...
                                              <el-form-item label="主键">{{props.row.id}}</el-form-item>
                                                                                ...
                                                                                <el-col :span="6">
                                              <el-form-item label="供应商">{{props.row.vendor_id}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="开户行">{{props.row.bank}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="账号">{{props.row.account}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="纳税人识别号">{{props.row.taxpayer_no}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
