            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label='单据状态' prop='status'>
                        ...
                        <el-select v-model="form.status" placeholder="请选择单据状态" style="width: 100%" size="small">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item label='报价日期' prop='date'>
                        <el-date-picker
                                type="date"
                                placeholder='请选择报价日期' size="small" v-model='form.date' style="width: 100%">
                        </el-date-picker>
                    </el-form-item>
                </el-col>
            </el-row>
...
<script>
    export default {
        ...
        created(){
            ...
            this.loadDanjvZhuangTaiList();
        },
        methods: {
            loadDanjvZhuangTaiList(){
                const that = this;
                that.$http.post("/api/dict/queryList", {
                    type: 9
                }).then(res => {
                    that.danjvZhuangTaiList = res.data;
                }).catch(err => {
