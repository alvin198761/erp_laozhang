                            ...
                            <el-form>
                                  <el-row :gutter="10">
                                              ...
                                              <el-form-item label="客户id">{{props.row.cus_id}}</el-form-item>
                                                                                ...
                                                                                <el-col :span="6">
                                              <el-form-item label="报价日期">{{props.row.date}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              ...
                                              <el-form-item label="总价">{{props.row.total}}</el-form-item>
                                                                                ...
                                                                                <el-col :span="6">
                                              <el-form-item label="单价">{{props.row.priice}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="备注">{{props.row.remark}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="单据状态">{{props.row.status}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
