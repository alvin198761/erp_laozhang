...
<template>
    <div>
        ...
        <SonghuozhuangtaiDictDialog ref="dialog" :refresh="refresh"></SonghuozhuangtaiDictDialog><br/>
    </div>
</template>
<script>
    import SonghuozhuangtaiDictDialog from './SonghuozhuangtaiDictDialog.vue';

    export default {
        components: { SonghuozhuangtaiDictDialog },
        data: function () {
            return {
                total: 0,
                page: 1,
