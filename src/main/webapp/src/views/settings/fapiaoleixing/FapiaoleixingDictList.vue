...
<template>
    <div>
        ...
        <FapiaoleixingDictDialog ref="dialog" :refresh="refresh"></FapiaoleixingDictDialog><br/>
    </div>
</template>
<script>
    import FapiaoleixingDictDialog from './FapiaoleixingDictDialog.vue';

    export default {
        components: { FapiaoleixingDictDialog },
        data: function () {
            return {
                total: 0,
                page: 1,
