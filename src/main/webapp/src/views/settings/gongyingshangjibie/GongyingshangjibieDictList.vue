/*类型字典管理,作者:唐植超,日期:2018-11-27 14:04:59*/
<template>
    <div>
        <el-form :inline="true">
        ...
        <GongyingshangjibieDictDialog ref="dialog" :refresh="refresh"></GongyingshangjibieDictDialog><br/>
    </div>
</template>
<script>
    import GongyingshangjibieDictDialog from './GongyingshangjibieDictDialog.vue';

    export default {
        components: { GongyingshangjibieDictDialog },
        data: function () {
            return {
                total: 0,
                page: 1,
