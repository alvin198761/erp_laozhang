...
<template>
    <div>
        ...
        <JiageleixingDictDialog ref="dialog" :refresh="refresh"></JiageleixingDictDialog><br/>
    </div>
</template>
<script>
    import JiageleixingDictDialog from './JiageleixingDictDialog.vue';

    export default {
        components: { JiageleixingDictDialog },
        data: function () {
            return {
                total: 0,
                page: 1,
