...
<template>
    <div>
        ...
        <DanjvzhuangtaiDictDialog ref="dialog" :refresh="refresh"></DanjvzhuangtaiDictDialog><br/>
    </div>
</template>
<script>
    import DanjvzhuangtaiDictDialog from './DanjvzhuangtaiDictDialog.vue';

    export default {
        components: { DanjvzhuangtaiDictDialog },
        data: function () {
            return {
                total: 0,
                page: 1,
