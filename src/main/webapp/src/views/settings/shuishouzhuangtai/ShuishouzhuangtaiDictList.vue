...
<template>
    <div>
        ...
        <ShuishouzhuangtaiDictDialog ref="dialog" :refresh="refresh"></ShuishouzhuangtaiDictDialog><br/>
    </div>
</template>
<script>
    import ShuishouzhuangtaiDictDialog from './ShuishouzhuangtaiDictDialog.vue';

    export default {
        components: { ShuishouzhuangtaiDictDialog },
        data: function () {
            return {
                total: 0,
                page: 1,
