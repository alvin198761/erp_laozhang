...
<template>
    <div>
        ...
        <FapiaozhuangtaiDictDialog ref="dialog" :refresh="refresh"></FapiaozhuangtaiDictDialog><br/>
    </div>
</template>
<script>
    import FapiaozhuangtaiDictDialog from './FapiaozhuangtaiDictDialog.vue';

    export default {
        components: { FapiaozhuangtaiDictDialog },
        data: function () {
            return {
                total: 0,
                page: 1,
