                            ...
                            <el-form>
                                  <el-row :gutter="10">
                                              ...
                                              <el-form-item label="主键">{{props.row.id}}</el-form-item>
                                                                                ...
                                                                                <el-col :span="6">
                                              <el-form-item label="供应商id">{{props.row.vendor_id}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="税收类型">{{props.row.tax_type}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="产品id">{{props.row.prod_id}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              ...
                                              <el-form-item label="备注">{{props.row.remark}}</el-form-item>
                                                                                ...
                                                                                <el-col :span="6">
                                              <el-form-item label="数量">{{props.row.num}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="单价">{{props.row.price}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="总价">{{props.row.total}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="发票类型">{{props.row.ticket_type}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="税率">{{props.row.rate}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
                                              <el-form-item label="进出类型">{{props.row.type}}</el-form-item>
                                          </el-col>
                                                                                <el-col :span="6">
