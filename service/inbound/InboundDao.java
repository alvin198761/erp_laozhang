...
public class InboundDao extends BaseDao {
    ...
    */
    public String getSelectedItems(InboundCond cond){
        ...
        return "t.id,t.prod_id,t.date,t.ticket_type,t.ticket_status,t.remark,p.prod_name,p.prod_no,v.vendor_name,v.vendor_no"; //默认所有字段
        }
    ...
    */
    public String getJoinTables(){
        return " join product p on p.id = t.prod_id join vendor v on v.id = p.vendor_id  ";
    }
}